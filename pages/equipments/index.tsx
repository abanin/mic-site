...
"
      ...
      <MainLayout
        ...
        cardDesc="Технологическая платформа центра включает огромное количество единиц оборудования, выполняющих широкий диапазон функций. На многих единицах оборудования ты можешь работать лично, пройдя образовательные курсы"
      />
      <Container>
